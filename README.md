...
- Cabeçalho com Menu para acessar as seções da página

- Tela de conteúdo dividida em apresentação e formas de contato

    - Vitrine de produtos mais solicitados
...
- Inforamções completas e ao mesmo tempo bem resumidas para atrair o público